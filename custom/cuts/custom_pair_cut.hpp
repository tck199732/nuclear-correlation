...
inline void custom_pair_cut::set_kT_gate(const double &vmin, const double &vmax) { this->kT_gate = {vmin, vmax}; }

inline void custom_pair_cut::set_consider_detector_effect(const bool &v) { this->is_consider_detector_effect = v; }
